...
const targetFormats = ["jpg", "png", "svg", "gif", "webp"];
const targetWidths = 1920;
...
const processImage = async () => {
  try {
    ...
    for (const file of files) {
      ...
      await sharp(inputPath).resize(targetWidths).toFile(outputPath);
      ...
      console.log(chalk.blueBright(`Se ha optimizado la imagen: ${file}`));
    }
